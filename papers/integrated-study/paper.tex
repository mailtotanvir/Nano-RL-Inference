...
\paragraph{Reproducibility.} Code, frozen data manifest, campaign ledger, per-seed metrics, benchmark JSON, and claim-evidence matrix are in \url{https://github.com/mailtotanvir/Nano-RL-Inference}. The selected adapter is at \url{https://huggingface.co/mailtotanvir/nano-rl-inference-arithmetic-sft-adapter}. Cite the Zenodo concept DOI \url{https://doi.org/10.5281/zenodo.22886076}; version 0.1.1 is pinned by \url{https://doi.org/10.5281/zenodo.22886166}.
\end{document}
